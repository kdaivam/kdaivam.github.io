...
import {
  ...
  return (
    ...
    <div className="container container-fluid">
          ...
          <p className="lead text-center" style={{fontSize:'22px'}}>If you need to reach out to me w.r.t any questions about data engineering, 
              please feel free to to email me at  
            <a href="kanya.daivam@gmail.com">{" "}
               kanya.daivam@gmail.com
            </a>{"."}
          </p>
